    ...
    <header class="sticky top-0 z-40 border-b border-white/10 bg-white/10 backdrop-blur-xl backdrop-saturate-150">
        <div class="mx-auto flex h-12 max-w-245 items-center justify-between px-4 md:px-6">
            <div class="flex items-center gap-3">
                ...
                <span class="apple-micro hidden text-white/50 sm:inline">手元对齐工具</span>
            </div>
            <a
                :href="repoUrl"
                target="_blank"
                rel="noopener"
                class="flex items-center justify-center text-white/80 transition-colors hover:text-white"
                aria-label="GitHub"
            >
